...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    Element_Element$html(html) {
      var t2, it, result,
        t1 = document.body;
      t1.toString;
      t2 = type$._ChildNodeListLazy;
      t2 = new A.WhereIterable(new A._ChildNodeListLazy(B.BodyElement_methods.createFragment$3$treeSanitizer$validator(t1, html, null, null)), t2._eval$1("bool(ListMixin.E)")._as(new A.Element_Element$html_closure()), t2._eval$1("WhereIterable<ListMixin.E>"));
    ...
    main() {
      var t2,
        t1 = document.querySelector("#concat");
      if (t1 != null) {
        t1 = J.get$onClick$x(t1);
        t2 = t1.$ti;
        t2._eval$1("~(1)?")._as(A.add__geeksForGeeks$closure());
        type$.nullable_void_Function._as(null);
        A._EventStreamSubscription$(t1._target, t1._eventType, A.add__geeksForGeeks$closure(), false, t2._precomputed1);
      }
    },
    geeksForGeeks(e) {
      var elemento, t1;
      type$.MouseEvent._as(e);
      elemento = A.Element_Element$html('<div class="farmaciasim"><a href=""><img src="as.jpg" alt="prueba"></a><div class="texto2"></div></div>');
      t1 = document.body;
      if (t1 != null)
  ...
  A.Element.prototype = {
    ...
    createFragment$3$treeSanitizer$validator(receiver, html, treeSanitizer, validator) {
      var t2, e, t3, contextElement, fragment,
        t1 = $.Element__defaultValidator;
      if (t1 == null) {
        t1 = A._setArrayType([], type$.JSArray_NodeValidator);
        t2 = new A.NodeValidatorBuilder(t1);
        e = document.createElement("a");
        t3 = new A._SameOriginUriPolicy(e, type$.Location._as(window.location));
  ...
  (function installTearOffs() {
    ...
    _static(A, "html__Html5NodeValidator__standardAttributeValidator$closure", 4, null, ["call$4"], ["_Html5NodeValidator__standardAttributeValidator"], 5, 0);
    _static(A, "html__Html5NodeValidator__uriAttributeValidator$closure", 4, null, ["call$4"], ["_Html5NodeValidator__uriAttributeValidator"], 5, 0);
    _static_1(A, "add__geeksForGeeks$closure", "geeksForGeeks", 17);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.Iterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.MapMixin, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A._Zone, A.__SetBase_Object_SetMixin, A._LinkedHashSetCell, A._LinkedHashSetIterator, A._ListBase_Object_ListMixin, A.ListMixin, A.SetMixin, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A._Html5NodeValidator, A.ImmutableListMixin, A.NodeValidatorBuilder, A._SimpleNodeValidator, A.FixedSizeListIterator, A._SameOriginUriPolicy, A._ValidatingTreeSanitizer]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSArray, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, A.EventTarget, A.DomException, A.DomImplementation, A.Event, A._HtmlCollection_JavaScriptObject_ListMixin, A.Location, A._NodeList_JavaScriptObject_ListMixin, A.__NamedNodeMap_JavaScriptObject_ListMixin]);
