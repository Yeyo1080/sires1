...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (t1 != null) {
        ...
        t2 = t1.$ti;
        t2._eval$1("~(1)?")._as(A.new__geeksForGeeks$closure());
        type$.nullable_void_Function._as(null);
        A._EventStreamSubscription$(t1._target, t1._eventType, A.new__geeksForGeeks$closure(), false, t2._precomputed1);
      }
    },
    geeksForGeeks(e) {
      return A.geeksForGeeks$body(type$.MouseEvent._as(e));
    },
    geeksForGeeks$body(e) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        t1, t2, s1;
      var $async$geeksForGeeks = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              s1 = t2._as(t1.querySelector("#name")).value;
              t2._as(t1.querySelector("#num")).value;
              t1 = t1.querySelector("#output");
              if (t1 != null)
                J.set$text$x(t1, "farmacia registrada: " + A.S(s1));
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$geeksForGeeks, $async$completer);
    }
  },
  J = {
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "new__geeksForGeeks$closure", "geeksForGeeks", 14);
  })();
  (function inheritance() {
    var _inherit = hunkHelpers.inherit,
      _inheritMany = hunkHelpers.inheritMany;
    _inherit(A.Object, null);
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.Rti, A._FunctionParameters, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A._StreamIterator, A._Zone, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider]);
