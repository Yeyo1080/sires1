...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    DateTime$utc(year, month, day) {
      var t1 = A.Primitives_valueFromDecomposedDate(year, month, day, 0, 0, 0, 0, true);
      if (!A._isInt(t1))
    ...
    main(args) {
      var fechn, fechn1, details1, details2, details3, _s6_ = "nombre",
        _s14_ = "nombre titular",
        _s9_ = "direccion",
        _s8_ = "telefono",
        _s14_0 = "Actualizacion1",
        _s9_0 = "admin@d23",
        _s43_ = "proxima actualizacion de Termohidrometros: ",
        t1 = $.$get$now(),
        t2 = type$.DateTime,
        t3 = t2._as($.$get$fech());
      t1 = t1._value;
      fechn = A.Duration$(t1 - t3._value);
      fechn1 = A.Duration$(t1 - t2._as($.$get$fech2())._value);
      t2 = type$.JsLinkedHashMap_dynamic_dynamic;
      details1 = new A.JsLinkedHashMap(t2);
      details1.$indexSet(0, _s6_, "Farmacias Rob");
      details1.$indexSet(0, _s14_, "Roberto Martinez castillo");
      details1.$indexSet(0, _s9_, "Lic. Hern\xe1ndez y Fern\xe1ndez #105, San Antonio, 42083 Pachuca de Soto, Hgo.");
      details1.$indexSet(0, _s8_, "771 809 6647");
      details1.$indexSet(0, _s14_0, fechn.toString$0(0) + " dias");
      details2 = new A.JsLinkedHashMap(t2);
      details2.$indexSet(0, _s6_, "farmacias hack");
      details2.$indexSet(0, _s14_, _s9_0);
      details2.$indexSet(0, _s9_, "Av Del Venado 301, Real de Pachuca, 42083 Pachuca de Soto, Hgo.");
      details2.$indexSet(0, _s8_, "771 236 2391");
      details2.$indexSet(0, _s14_0, fechn1.toString$0(0) + " dias");
      details3 = new A.JsLinkedHashMap(t2);
      details3.$indexSet(0, _s6_, "admin");
      details3.$indexSet(0, _s14_, _s9_0);
      details3.$indexSet(0, _s9_, "admin");
      details3.$indexSet(0, _s8_, _s9_0);
      details3.$indexSet(0, _s14_0, fechn.toString$0(0) + " dias");
      t2 = document;
      t1 = t2.querySelector("#far1d1");
      if (t1 != null)
        J.set$text$x(t1, A.S(details1.$index(0, _s6_)));
      t1 = t2.querySelector("#far1d2");
      if (t1 != null)
        J.set$text$x(t1, "  Due\xf1o: " + A.S(details1.$index(0, _s14_)));
      t1 = t2.querySelector("#far1d3");
      if (t1 != null)
        J.set$text$x(t1, "  Dirreccion: " + A.S(details1.$index(0, _s9_)));
      t1 = t2.querySelector("#far1d4");
      if (t1 != null)
        J.set$text$x(t1, "  Tel: " + A.S(details1.$index(0, _s8_)));
      t1 = t2.querySelector("#far1d5");
      if (t1 != null)
        J.set$text$x(t1, _s43_ + A.S(details1.$index(0, _s14_0)));
      t1 = t2.querySelector("#far2d1");
      if (t1 != null)
        J.set$text$x(t1, A.S(details2.$index(0, _s6_)));
      t1 = t2.querySelector("#far2d2");
      if (t1 != null)
        J.set$text$x(t1, "  Due\xf1o: " + A.S(details2.$index(0, _s14_)));
      t1 = t2.querySelector("#far2d3");
      if (t1 != null)
        J.set$text$x(t1, "  Dirreccion: " + A.S(details2.$index(0, _s9_)));
      t1 = t2.querySelector("#far2d4");
      if (t1 != null)
        J.set$text$x(t1, "  Tel: " + A.S(details2.$index(0, _s8_)));
      t1 = t2.querySelector("#far2d5");
      if (t1 != null)
        J.set$text$x(t1, _s43_ + A.S(details2.$index(0, _s14_0)));
    }
  },
  J = {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.MapMixin, A.LinkedHashMapCell, A.Rti, A._FunctionParameters, A.DateTime, A.Duration, A.OutOfMemoryError, A.Null, A.StringBuffer]);
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "now", "$get$now", () => new A.DateTime(Date.now(), false));
    _lazy($, "fech", "$get$fech", () => A.DateTime$utc(2023, 5, 10));
    _lazy($, "fech2", "$get$fech2", () => A.DateTime$utc(2023, 7, 10));
  })();
